...
For **REGO**, add a verified screenshot as `rego.webp` (or `rego.png`) together with its public-safe description and links. It is intentionally not shown in the current gallery because no verifiable REGO asset or URL was available in this repository.
